...
|          | `--delay-directory-restore`                    | FEATUERE     | delay setting modification times and permissions of extracted directories until the end of extraction | Matches bottom-up permissions plan in TODO.                                               | permissions / extract |
|          | `--no-delay-directory-restore`                 | FEATUERE     | cancel the effect of `--delay-directory-restore`                                                      | ??? How --no-delay-directory-restore --delay-directory-restore                            | permissions / extract |
